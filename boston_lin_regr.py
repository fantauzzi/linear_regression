...
# %% [md]
# Fetch the dataset from its original source and load it
...
it's not clear how to use it for analysis to follow, whatever the usage intended by the dataset authors.
"""
columns = boston.feature_names[boston.feature_names != 'B']

"""
dataset_X => predictors only
...
# %% [md]
# Performa the simple linear regression of MEDV against LSTAT and output its stats
